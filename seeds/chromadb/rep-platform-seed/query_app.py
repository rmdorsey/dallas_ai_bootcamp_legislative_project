...
def main():
    ...
    embedding_config = config.get('model', {})

    embedding_model_name = embedding_config.get('name', 'sentence-transformers/all-mpnet-base-v2')
    chroma_collection_name = config.get('collection', 'platforms-republican-texas')
    ...
    while True:
        ...
        try:
            ...
            for i, (doc, score) in enumerate(results_with_scores):
                ...
                print(f"Header1: {metadata.get('header1', 'N/A')}, Page: {metadata.get('page', 'N/A')}")
                print(f"Header2: {metadata.get('header2', 'N/A')}")
                print(f"Header3: {metadata.get('header3', 'N/A')}")
                print(f"Header4: {metadata.get('header4', 'N/A')}")
                print("-" * 20)
